=== LiquidPoll - FluentCRM Integration ===
    ...
    Integrate FluentCRM in Liquidpoll plugin.

== Description ==

Integration with FluentCRM to Liquidpoll plugin.

By using FluentCRM and LiquidPoll together with this integrator plugin, you can directly onboard users with a poll and get them segmented by their responses into the CRM database according to **tags** and **lists**.
...
**Required Plugins**
    ...
    * [FluentCRM Free](https://wordpress.org/plugins/fluent-crm/)
    * LiquidPoll – FluentCRM Integration plugin


### How to use?
To transform any poll into a FluentCRM input tool you need to have this integrator plugin installed. Any member or participant who are responding to your poll gets automatically tagged and segmented by this process.

### Polls Connected to Lists & Tags
Any poll you have created can be assigned to a FluentCRM **List** or **Tag**.

Simply go to the **Form** tab of your poll and add the list and tag you want to associate.

### Poll Responses Connected to Tags
Any poll otions can also be associated with a tag you have created in FluentCRM.
...
2. Go your plugin settings via WordPress Dashboard and find "<strong>LiquidPoll - FluentCRM Integration </strong>" activate it.<br />
...
= 1.0.0 =
* 24/10/2022 - NEW - Initial release.
